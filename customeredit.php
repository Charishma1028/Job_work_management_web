...
<body>
    ...
    <div class="container">
        <h2 class="cust_reg_hdng">Edit Customer</h2>
...
<?php
 if(isset($_POST['submit'])){
    ...
    $Cust_Id=$_POST['id'];
    $Cust_CompanyName=$_POST['name'];
    $Cust_add1=$_POST['adline1'];
    $Cust_add2=$_POST['adline2'];
    $Cust_add3=$_POST['adline3'];
    $Cus_City=$_POST['city'];
    $Cust_State=$_POST['state'];
    $Cust_PIN=$_POST['pin'];
    $Cust_ContactPerson=$_POST['cntpr'];
    $Cust_Phone1=$_POST['phone1'];
    $Cust_Phone2=$_POST['phone2'];
    $cust_Mail1=$_POST['email'];
    
    $sql="UPDATE jwm_custmaster SET Cust_CompanyName='$_POST[name]', Cust_add1='$_POST[adline1]' , Cust_add2='$_POST[adline2]', Cust_add3='$_POST[adline3]',Cus_City='$_POST[city]', Cust_State='$_POST[state]', Cust_PIN='$_POST[pin]', Cust_ContactPerson='$_POST[cntpr]', Cust_Phone1='$_POST[phone1]', Cust_Phone2='$_POST[phone2]', cust_Mail1='$_POST[email]' WHERE Cust_Id='$_POST[id]'";
