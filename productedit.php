...
<?php
 if(isset($_POST['submit'])){
    ...
    $Prod_Type=$_POST['good'];
    $Prod_Unit_ID=$_POST['unit'];
    $Prod_Status=$_POST['status'];
    
    $sql="UPDATE jwm_productmaster SET Prod_Name='$_POST[name]',Prod_Status='$_POST[status]',Prod_Desc='$_POST[desc]',Prod_Type='$_POST[good]',Prod_Unit_ID='$_POST[good]' WHERE Prod_Id='$_POST[id]'";
